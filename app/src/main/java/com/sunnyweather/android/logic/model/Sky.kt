...
private val sky = mapOf(
    "CLEAR_DAY" to Sky(
        "晴", R.drawable.ic_clear_day,
        R.drawable.bg_clear_day
    ),
    "CLEAR_NIGHT" to Sky(
        "晴", R.drawable.ic_clear_night,
    ...
    "STORM_RAIN" to Sky(
        "暴⾬", R.drawable.ic_storm_rain,
        R.drawable.bg_rain
    ),
    "THUNDER_SHOWER" to Sky(
        "雷阵⾬", R.drawable.ic_thunder_shower,
        R.drawable.bg_rain
    ),
    "SLEET" to Sky("⾬夹雪", R.drawable.ic_sleet, R.drawable.bg_rain),
    "LIGHT_SNOW" to Sky(
        "⼩雪", R.drawable.ic_light_snow,
        R.drawable.bg_snow
    ),
